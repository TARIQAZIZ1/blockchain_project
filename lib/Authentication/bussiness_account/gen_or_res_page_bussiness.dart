...
class GenOrResBuss extends StatefulWidget {
  const GenOrResBuss({Key key}) : super(key: key);

  @override
  _GenOrResBussState createState() => _GenOrResBussState();
}

class _GenOrResBussState extends State<GenOrResBuss> {
  @override
